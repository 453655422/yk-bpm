...
public class TCatelogDAO extends HibernateDaoSupport
{
	...
	public List find(String catelogName)
	{
		log.debug("finding  TCatelog instances");
		try
		{
			String queryString = "from TCatelog where catelogName like '%"+catelogName+"%' order by catelogId desc";
