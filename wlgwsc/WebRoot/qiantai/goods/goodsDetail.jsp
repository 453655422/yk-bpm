...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <tr><td width="30"></td><td style="font-size: 11px;">商品图片：</td><td style="font-size: 11px;">	
																   <img width="105" height="110" src="<%=path %>/<s:property value="#request.goods.goodsPic"/>"/>
																</td></tr>			  								  
								  
								  
								  
                                      <tr><td width="30"></td><td style="font-size: 11px;">商品名称：</td><td style="font-size: 11px;"><s:property value="#request.goods.goodsName"/></td></tr>
									  
									  
                                      <tr><td width="30"></td><td style="font-size: 11px;">商品描述：</td><td style="font-size: 11px;"><s:property value="#request.goods.goodsMiaoshu" escape="false"/></td></tr>
                                      <tr><td width="30"></td><td style="font-size: 11px;">市场价格：</td><td style="font-size: 11px;"><s:property value="#request.goods.goodsShichangjia"/></td></tr>
									    <tr><td width="30"></td><td style="font-size: 11px;">特价价格：</td><td style="font-size: 11px;"><s:property value="#request.goods.goodsTejia"/></td></tr>
