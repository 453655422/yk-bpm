...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function goodsShezhiTejia(goodsId,goodsShichangjia)
           {
                var pop=new Popup({ contentType:1,isReloadOnClose:false,width:400,height:200});
	            pop.setContent("contentUrl","<%=path %>/admin/goods/goodsShezhiTejia.jsp?goodsShichangjia="+goodsShichangjia+"&goodsId="+goodsId);
	            pop.setContent("title","文件上传");
	            pop.build();
	            pop.show();
           }
           function goodsQxTejia(goodsId,goodsShichangjia)
           {
                var pop=new Popup({ contentType:1,isReloadOnClose:false,width:400,height:200});
	            pop.setContent("contentUrl","<%=path %>/admin/goods/goodsShezhiTejia.jsp?goodsShichangjia="+goodsShichangjia+"&goodsId="+goodsId);
	            pop.setContent("title","文件上传");
           ...
           {
                   window.location.href="<%=path %>/goodsEditPre.action?goodsId="+goodsId;
           }	
       </script>
	</head>

	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
	<form action="goodsQuery.action" method="post">
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="4" background="<%=path %>/images/tbg.gif">&nbsp;查询&nbsp;</td>
				</tr>
				<tr>
					<td bgcolor="#FFFFFF">按商品名称关键字&nbsp;&nbsp;&nbsp;<input type="text" id="goodsName" name="goodsName" />&nbsp;&nbsp;&nbsp;<input type="submit" value="查询"/></td>
				</tr>
	</table>
	</form>
			<table width="1200" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="13" background="<%=path %>/images/tbg.gif">&nbsp;商品信息管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					     <s:if test="#goods.goodsIsnottejia=='no'">无特价&nbsp;&nbsp;&nbsp;
					         <a href="#" style="color: red" onclick="goodsShezhiTejia(<s:property value="#goods.goodsId"/>,<s:property value="#goods.goodsShichangjia"/>)">设为特价</a>
					     </s:if>
					     <s:if test="#goods.goodsIsnottejia=='yes'">
					        <s:property value="#goods.goodsTejia"/>
					        <a href="<%=path %>/goodsQxTejia.action?goodsId=<s:property value="#goods.goodsId"/>&goodsShichangjia=<s:property value="#goods.goodsShichangjia"/>" style="color: red" >取消特价</a>
					     </s:if>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<a href="#" onclick="goodsEdit(<s:property value="#goods.goodsId"/>)" class="pn-loperator">编辑</a>
					</td>
				</tr>
				</s:iterator>
			</table>
