	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items5_1'>
	          <ul class='sitemu'>
	             ...
	             <li><a href='<%=path %>/goodsManaNoTejia.action' target='main'>商品信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items6_1")'><b>商品订单管理</b></dt>
	        <dd style='display:block' class='sitem' id='items6_1'>
	          <ul class='sitemu'>
	             <li><a href='<%=path %>/userMana.action' target='main'>会员管理</a> </li>
	             <li><a href='<%=path %>/orderMana.action' target='main'>商品订单管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
