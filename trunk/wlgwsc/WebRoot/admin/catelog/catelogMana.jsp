...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
		<form action="catelogQuery.action" method="post">
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="4" background="<%=path %>/images/tbg.gif">&nbsp;查询&nbsp;</td>
				</tr>
				<tr>
					<td bgcolor="#FFFFFF">按类别关键字&nbsp;&nbsp;&nbsp;<input type="text" id="catelogName" name="catelogName" />&nbsp;&nbsp;&nbsp;<input type="submit" value="查询"/></td>
				</tr>
	</table>
	</form>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<a href="#" onclick="catelogEditPre(<s:property value="#catelog.catelogId"/>)" class="pn-loperator">编辑</a>
					</td>
				</tr>
				</s:iterator>
			</table>
