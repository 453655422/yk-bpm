        ...
        <script language="javascript">
           ...
           function gonggaoDetail(gonggaoId)
           {
				 ...
				 openWin(url,n,w,h,s);
                      ...
                      function gonggaoEdit(gonggaoId)
           {
                   window.location.href="<%=path %>/gonggaoEditPre.action?gonggaoId="+gonggaoId;
           }
       </script>
	</head>

	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
	<form action="gonggaoQuery.action" method="post">
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="4" background="<%=path %>/images/tbg.gif">&nbsp;查询&nbsp;</td>
				</tr>
				<tr>
					<td bgcolor="#FFFFFF">按标题关键字&nbsp;&nbsp;&nbsp;<input type="text" id="gonggaoTitle" name="gonggaoTitle" />&nbsp;&nbsp;&nbsp;<input type="submit" value="查询"/></td>
				</tr>
	</table>
	</form>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<a href="#" onclick="gonggaoEdit(<s:property value="#gonggao.gonggaoId"/>)" class="pn-loperator">编辑</a>
					</td>
				</tr>
				</s:iterator>
			</table>
