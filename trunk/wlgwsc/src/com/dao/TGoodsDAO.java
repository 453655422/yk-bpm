...
public class TGoodsDAO extends HibernateDaoSupport
{
	...
	public void edit(TGoods transientInstance)
	{
		log.debug("editing TGoods instance");
		try
		{
	...
	public List find(String goodsName)
	{
		log.debug("finding  TGoods instances");
		try
		{
			String queryString = "from TGoods where goodsName like '%"+goodsName+"%' order by goodsId desc";
